...
def create_connection(db, user, password):
    ...
    cursor.execute("PREPARE review_insert (varchar, timestamp with time zone, char, real, text, varchar, varchar, char) as insert into reviews values ($1, $2, $3, $4, $5, $6, $7, $8);")
    cursor.close()
